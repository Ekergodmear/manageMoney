...
export interface ScenarioCompareTable {
...
function roiPercent(experiment: ScenarioExperiment): number | null {
...
interface MetricDef {
  ...
  readonly pick: (e: ScenarioExperiment) => string;
  readonly numeric?: (e: ScenarioExperiment) => number | null;
}
...
export function buildScenarioCompareTable(
  experiments: readonly ScenarioExperiment[],
): ScenarioCompareTable | null {
