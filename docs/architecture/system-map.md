...
| --------- | ------- | -------- |
| Tạo mới | *Tôi muốn chơi như thế nào?* | Planning → Session |
| Đề xuất thay đổi | *Có cách nào tốt hơn / với vốn này?* | Recommendation → Candidate → Promote |
| Tiếp tục chơi | *Đã hết plan hiện tại — làm tiếp?* | Session → Continue → Plan |
| Quản lý phiên | *Đang chơi / dừng / thắng?* | Session aggregate (timeline + plans) |
